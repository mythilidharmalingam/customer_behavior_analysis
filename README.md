...
This project represents a complete data analytics workflow, designed to mirror the real responsibilities of professional analysts in modern business environments. The project encompasses all critical stages of data analysis, from data preparation and modeling to insight generation, visualization, and reporting.
...
1. **Open Customer_Shopping_Behavior_Analysis.ipynb notebook**
    ...
    This file contains:
      ...
      - Data Import from customer_shopping_behavior.csv 
